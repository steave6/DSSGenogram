...
namespace DSSGenogram.Utils
{
    public static class ShowcaseHelper
    {
        ...
        /// General data source
        /// </summary>
        public static List<DataVertex> DataSource { get; set; }
        ...
        {
            var list = new List<DataVertex>();
            for (var i = 0; i < count; i++)
            {
                list.Add(new DataVertex { ID = i, Text = "Vertex " + i });
            }
            DataSource = list;
        }
        ...
        public static GraphField GenerateDataGraph(int count, bool addEdges = true, int edgeCountMult = 25)
        {
        ...
        public static GraphField GenerateSugiDataGraph()
        {
            var graph = new GraphField();
        ...
        private static void AddNewEdge(this GraphField graph, DataVertex source, DataVertex target, long id)
        {
