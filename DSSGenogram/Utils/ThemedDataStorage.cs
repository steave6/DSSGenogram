...
namespace DSSGenogram.Utils
{
    public static class ThemedDataStorage
    {
        ...
        {
            Images.Add(new BitmapImage(new Uri(@"pack://application:,,,/DSSGenogram;component/Assets/female.png", UriKind.Absolute)) { CacheOption = BitmapCacheOption.OnLoad });
            Images.Add(new BitmapImage(new Uri(@"pack://application:,,,/DSSGenogram;component/Assets/male.png", UriKind.Absolute)) { CacheOption = BitmapCacheOption.OnLoad });
            EditorImages.Add(new BitmapImage(new Uri(@"pack://application:,,,/DSSGenogram;component/Assets/hand_comp.png", UriKind.Absolute)) { CacheOption = BitmapCacheOption.OnLoad });
            EditorImages.Add(new BitmapImage(new Uri(@"pack://application:,,,/DSSGenogram;component/Assets/hand_comp2.png", UriKind.Absolute)) { CacheOption = BitmapCacheOption.OnLoad });
            EditorImages.Add(new BitmapImage(new Uri(@"pack://application:,,,/DSSGenogram;component/Assets/hand_comp3.png", UriKind.Absolute)) { CacheOption = BitmapCacheOption.OnLoad });
        }
