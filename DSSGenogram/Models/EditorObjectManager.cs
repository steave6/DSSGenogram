...
namespace DSSGenogram.Models
{
    public class EditorObjectManager: IDisposable
    {
        private GraphAreaUnit _graphArea;
        private ZoomControl _zoomControl;
        private EdgeBlueprint _edgeBp;
        private ResourceDictionary _rd;

        public EditorObjectManager(GraphAreaUnit graphArea, ZoomControl zc)
        {
            ...
            {
                Source = new Uri("/DSSGenogram;component/Templates/FamilyTree.xaml",
